...
| Nisshinbo Micro Devices (listed by DigiKey) | n/a (distributor product page for MUSES8921ANAE2S, EMP-8 package; links the datasheet) | revision not shown | not shown | [digikey.com/en/products/detail/nisshin…S8921ANAE2S/28174519](https://www.digikey.com/en/products/detail/nisshinbo-micro-devices-inc/MUSES8921ANAE2S/28174519) | product_page | low | DigiKey lists the orderable part MUSES8921ANAE2S as 'Standard (General Purpose) Amplifier 2 Circuit Single-Ended 8-EMP'. The search summary did not show which datasheet version the page links to. No MUSES8921 PDF under mouser.com/datasheet or DigiKey mm.digikey.com was found; those hits were MUSES8920 only. |
| Nisshinbo Micro Devices | n/a (English news release) | n/a | 2025-10-09 | [nisshinbo-microdevices.co.jp/en/about/info/20251009.html](https://www.nisshinbo-microdevices.co.jp/en/about/info/20251009.html) | product_page | high | Vendor launch announcement. It sets the earliest date the Ver.1.0 datasheet can be tied to. It appeared in the lineage notes but not in known_datasheets. |
| Nisshinbo Micro Devices (listed by everythingPE) | n/a (third-party product listing) | revision not shown | not shown | [everythingpe.com/products/power-operat…353-muses8921-series](https://www.everythingpe.com/products/power-operational-amplifiers/nisshinbo-micro-devices/1071-353-muses8921-series) | product_page | low | Aggregator product page. The search summary did not show whether it holds a datasheet copy or its version. |
| Nisshinbo Micro Devices (alldatasheetcn.com search index) | MUSES8921 | revision not shown | not shown | [alldatasheetcn.com/view_datasheet.jsp?Searchword=MUSES8921](https://www.alldatasheetcn.com/view_datasheet.jsp?Searchword=MUSES8921) | third_party_mirror | low | Chinese sister site of alldatasheet. This is a search/index page, probably pointing to the same file as alldatasheet.jp entry 2271959, which is already listed. No version was shown. |
| Nisshinbo Micro Devices (MUSES8921AN on a DIP adapter, sold by Digit / Joshin DIGIT BASE shop) | n/a (retail listing of MUSES8921AN mounted on a DIP-8 conversion board) | revision not shown | not shown | [digit.theshop.jp/items/132565365](https://digit.theshop.jp/items/132565365) | product_page | low | Hobby retail listing. It shows the AN (EMP-8) variant being sold in Japan on a DIP-8 adapter. It is not a datasheet copy. |
| Nisshinbo Micro Devices (MUSES8921AN DIP module sold by Kyoritsu eleshop) | n/a (retail listing) | revision not shown | not shown | [eleshop.jp/shop/g/gQ1U411/](https://eleshop.jp/shop/g/gQ1U411/) | product_page | low | Kyoritsu Electric's eleshop listing for the same MUSES8921AN-DIP module. It is not a datasheet copy. |
| Nisshinbo Micro Devices (Datasheet Archive MUSES index) | n/a (generic MUSES index page) | revision not shown | not shown | [datasheetarchive.com/muses-datasheet.html](https://datasheetarchive.com/muses-datasheet.html) | third_party_mirror | low | Generic index of MUSES-family datasheets that came up for MUSES8921 queries. The search result did not confirm that it holds a MUSES8921 file. |

### Revision chain status

MUSES8921 has one vendor document with two language editions, both from Nisshinbo Micro Devices. There are no acquirer reissues and no second sources. Its JRC/NJR ancestry belongs to separate part numbers (MUSES8920 at Ver.2012-04-02 and Ver.10, then MUSES8920A).  (1) MUSES8921_J (Japanese). Ver.1.0 is the only version known, released at launch on 2025-10-09. Holding copies: akizukidenshi.com/goodsaffix/MUSES8921_J.pdf (the title shows Ver.1.0) and the vendor's /ja/pdf/datasheet/MUSES8921_J.pdf.  (2) MUSES8921_E (English). Ver.1.0 is the only version known, per the search summary for the topas.de copy; the title did not show it. Holding copies: topas.de and the vendor's /en/pdf/datasheet/MUSES8921_E.pdf.  Across 4 searches, no Ver.1.1, Ver.2.0 or later edition turned up in either language. The part is less than a year old, so there are no earlier editions to find. The only chain link that could still be missing is a quiet post-launch update in place at the vendor URLs. To catch one, the vendor PDF URLs are added as archive seeds so Wayback captures can be compared. The date and version inside the vendor-hosted PDFs have still not been checked directly.  Distributor coverage found: DigiKey product page for MUSES8921ANAE2S (version not shown); retail DIP-module listings at digit.theshop.jp and eleshop.jp; index pages at alldatasheetcn and datasheetarchive. No MUSES8921 copy was found at mouser.com/datasheet, mm.digikey.com, LCSC, Octopart or datasheet4u; the Mouser and DigiKey PDF hits were MUSES8920 only.
...
| Nisshinbo Micro Devices | MUSES8921_E (English datasheet) | Ver.1.0 | not shown (product released 2025-10-09) | First English edition. The web-search summary calls the topas.de copy (MUSES8921_E.pdf) 'Ver.1.0', but the PDF title in the result did not show the Ver. string (medium confidence). It lists these variants: MUSES8921AN (EMP-8-AN, 3.9x5.0x1.65 mm) and MUSES8921GR (DFN4035-8-GR, 4.0x3.5x0.75 mm). Typical specs are 8.0 nV/rtHz, 0.0004% THD, 25 V/us, 11 MHz GBP, 5 pA Ib and a +/-3.5 V to +/-17 V supply. No later English Ver. was found as of Sep 2026. |
