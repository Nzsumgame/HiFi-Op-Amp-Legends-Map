...
| Texas Instruments | SBOS377A | A | OCTOBER 2006 – REVISED FEBRUARY 2007 | [scribd.com/document/939959332/Opa-2211](https://www.scribd.com/document/939959332/Opa-2211) | third_party_mirror | medium | A search summary names this Scribd document as SBOS377A (Oct 2006, revised Feb 2007). It is the first copy found of rev A, which had no URL before. It also came up first in the searches that surfaced the SBOS377D header, so check the header when you open it. |
| Texas Instruments | SBOS377 | revision not shown | unknown | [pdf.ic37.com/TI/OPA211_datasheet_5677509/OPA211_3.html](https://pdf.ic37.com/TI/OPA211_datasheet_5677509/OPA211_3.html) | third_party_mirror | low | 17 pages, the length of the old pre-2015 layout, so probably rev A–G. It turned up in the searches for SBOS377A/D/G headers, but the summaries did not tie a letter to this copy. Page 5 is at .../OPA211_5.html. |
| Texas Instruments | SBOS377 | revision not shown | unknown | [pdf.ic37.com/TI/OPA211_datasheet_6037225/](https://pdf.ic37.com/TI/OPA211_datasheet_6037225/) | third_party_mirror | low | Only 9 pages. It could be an early short edition (for example the Oct 2006 original or a product preview) or just a truncated upload. Unverified, but worth checking for the missing original. |
| Texas Instruments | SBOS377 | revision not shown | unknown | [pdf.ic37.com/TI/OPA2211AI_datasheet_13206397/](https://pdf.ic37.com/TI/OPA2211AI_datasheet_13206397/) | third_party_mirror | low | 37 pages, which fits TI's post-2015 layout (rev H or later). The revision is not shown. |
| Texas Instruments | SBOS377 | revision not shown | unknown | [100y.com.tw/pdf_file/33-TI-OPA211,2211.pdf](https://www.100y.com.tw/pdf_file/33-TI-OPA211,2211.pdf) | distributor_mirror | low | The page title matches the old (pre-rev H) layout also seen on the kyohritsu rev F and Mouser rev G copies, so this is rev A–G. The exact letter is not shown. |
| Texas Instruments | SBOS377 | revision not shown | unknown | [radiolocman.com/datasheet/data.html?di=82176](https://www.radiolocman.com/datasheet/data.html?di=82176) | third_party_mirror | low | A separate radiolocman entry from di=305537 (rev I). It is filed under the G4 (Pb-free, older-era) orderable, so it may be an older revision. Unverified. |
| Texas Instruments | SBOS377 | revision not shown | unknown | [datasheet.octopart.com/OPA211AIDR-Texa…asheet-159115562.pdf](https://datasheet.octopart.com/OPA211AIDR-Texas-Instruments-datasheet-159115562.pdf) | distributor_mirror | low | The title text ('Voltage Noise Density ...') matches the new-format layout, so rev H or later. The letter is not shown. |
| Texas Instruments | SBOS377 | revision not shown | unknown | [scribd.com/document/770726126/opa211](https://www.scribd.com/document/770726126/opa211) | third_party_mirror | low | A second Scribd upload. The revision was not shown in the summary. |
| Texas Instruments | SBOS377 | revision not shown | unknown | [datasheet4u.com/datasheet-pdf/Burr-Bro…11/pdf.php?id=574554](https://datasheet4u.com/datasheet-pdf/Burr-Brown/OPA2211/pdf.php?id=574554) | third_party_mirror | low | This is the datasheet4u entry the lineage note mentions, which had no URL before. The same file is also at https://datasheet4u.com/datasheets/Burr-Brown/OPA2211/574554. The 'Burr-Brown' filing is the site's own label. The revision is not shown, but the Burr-Brown filing suggests an early edition. |
| Texas Instruments | SBOS377 | revision not shown | unknown | [datasheet.b-cdn.net/posts/opa2211-datasheet/](https://datasheet.b-cdn.net/posts/opa2211-datasheet/) | third_party_mirror | low | This third-party post came up in the search for revisions B, C and E, but no revision was shown. |
| Texas Instruments | SBOS638 | revision not shown | unknown | [radiolocman.com/datasheet/data.html?di=305539](https://www.radiolocman.com/datasheet/data.html?di=305539) | third_party_mirror | low | OPA211-EP enhanced-product datasheet. The revision is not shown. The di number is close to the rev I OPA211 entry (di=305537), so this may be a copy from the same period (about 2016). Unverified. |
| Texas Instruments | SBOS638 | revision not shown | unknown | [alldatasheet.com/datasheet-pdf/pdf/463398/TI1/OPA211-EP.html](https://www.alldatasheet.com/datasheet-pdf/pdf/463398/TI1/OPA211-EP.html) | third_party_mirror | low | alldatasheet's OPA211-EP entry, separate from the OPA2211-EP entry 772560. The revision is not shown. The lower ID suggests it was archived around the 2012 original. |
| Texas Instruments | unknown | revision not shown | unknown | [datasheet4u.com/datasheets/etcTI/OPA2211-EP/1572858](https://datasheet4u.com/datasheets/etcTI/OPA2211-EP/1572858) | third_party_mirror | low | OPA2211-EP datasheet. The summary gives the description text (1.1 nV/rtHz, 3.6 mA) but not the TI literature number or revision. The OPA2211-EP doc number is still unidentified. |
| Texas Instruments | unknown | n/a | n/a | [ti.com/product/OPA2211-HT](https://www.ti.com/product/OPA2211-HT) | product_page | medium | New finding: a TI high-temperature (HT) variant of the OPA2211 has its own product page. It is not in the lineage yet, and its datasheet literature number has not been identified. |
| Texas Instruments | SBOS377 | n/a | n/a | [digikey.com/en/products/base-product/t…nts/296/OPA211/58988](https://www.digikey.com/en/products/base-product/texas-instruments/296/OPA211/58988) | product_page | low | DigiKey's product page for OPA211, which links the current datasheet. No revision is shown. |

### Revision chain status

TI SBOS377 (OPA211/OPA2211), oldest to newest: original Oct 2006 (no copy found; the 9-page pdf.ic37.com 6037225 file and the datasheet4u 'Burr-Brown' 574554 file are the best leads, revision not shown) -> A, revised Feb 2007 (NEW copy: scribd.com/document/939959332) -> B, C (MISSING: no header, date or copy found; must fall between Feb 2007 and Feb 2008) -> D, revised Feb 2008 (NEW: header 'SBOS377D – OCTOBER 2006 – REVISED FEBRUARY 2008' seen in search summaries, but the hosting copy is not identified) -> E (MISSING; must fall between Feb 2008 and Nov 2008) -> F, Nov 2008 (kyohritsu) -> G, May 2009 (Mouser) -> [6-year gap] -> H, Nov 2015 (no copy URL) -> I, Jun 2016 (radiolocman di=305537) -> J, Feb 2018 (no copy URL) -> K, Sep 2018 (no copy URL) -> L, Jan 2020 (ti.com symlink, re-rendered Nov 2025, still rev L). Old-format copies of unknown letter (rev A–G): 100y.com.tw 33-TI-OPA211,2211.pdf and pdf.ic37.com 5677509 (17 pages); possibly radiolocman di=82176 (OPA211AIDG4). New-format copies of unknown letter (rev H or later): pdf.ic37.com 13206397 (37 pages) and Octopart OPA211AIDR 159115562. TI SBOS638 (OPA211-EP): only the original, June 2012 (ti.com, Octopart) is confirmed. New copies with revision not shown: radiolocman di=305539 and alldatasheet 463398. Whether SBOS638 has later lettered revisions is still unknown. OPA2211-EP: literature number still unidentified; new copy at datasheet4u 1572858. NEW variant: an OPA2211-HT (high-temperature) product page exists at ti.com/product/OPA2211-HT; its datasheet number and revisions are unknown and it is not yet in the lineage. No second source or other vendor was found. Archive seeds: the focus.ti.com symlink URLs follow the task's legacy pattern. The per-revision seeds (sbos377a, sbos377d and sbos377g paths) are built from TI's standard lit-path pattern for confirmed letters and are unverified. Missing links still: copies of the original, B, C, D (host), E, H, J and K; SBOS638 revisions after the 2012 original; the OPA2211-EP and OPA2211-HT literature numbers.
...
| Texas Instruments | SBOS377D | D | February 2008 | Exists: two search summaries show the header 'SBOS377D – OCTOBER 2006 – REVISED FEBRUARY 2008'. No surviving copy was tied to it; it is probably among the Scribd 939959332, pdf.ic37.com 5677509 or kyohritsu results. Changes unknown. This leaves B and C between Feb 2007 and Feb 2008, and E between Feb 2008 and Nov 2008. |
| Texas Instruments | SBOS377A | A | February 2007 | First copy found: Scribd document 939959332 ('Opa 2211'), per a search summary. Changes are still unknown. |

### Legacy URLs searched in the Internet Archive

- `http://focus.ti.com/lit/ds/sbos377a/sbos377a.pdf`
- `http://focus.ti.com/lit/ds/sbos377d/sbos377d.pdf`
- `http://focus.ti.com/lit/ds/symlink/opa211-ep.pdf`
- `http://focus.ti.com/lit/ds/symlink/opa211.pdf`
- `http://focus.ti.com/lit/ds/symlink/opa2211.pdf`
- `http://www.ti.com/lit/ds/sbos377g/sbos377g.pdf`
