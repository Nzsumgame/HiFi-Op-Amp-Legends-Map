...
| New Japan Radio (NJR) | MUSES02_E | revision not shown | unknown | [njr.com/electronic_device/PDF/MUSES02_E.pdf](https://www.njr.com/electronic_device/PDF/MUSES02_E.pdf) | vendor_legacy | low | This legacy NJR vendor PDF path appeared in search results, but the result title showed only 'Njr', not the Ver. header. It is probably Ver.2015-04-13 or later, but that is unconfirmed. Seed it to the Wayback Machine, because snapshots may hold different Ver. dates. |
| New Japan Radio (NJR) | MUSES02_E | revision not shown | unknown | [semicon.njr.co.jp/eng/PDF/MUSES02_E.pdf](http://semicon.njr.co.jp/eng/PDF/MUSES02_E.pdf) | vendor_legacy | low | A search summary cited this URL, apparently from a diyAudio MUSE op-amp thread. It is an early NJR host and probably served the launch-era Ver.2009-12-18 or another pre-2015 Ver., but no header was shown. It is the best archive seed for early English revisions. |
| New Japan Radio (NJR) | - | - | - | [njr.com/semicon/products/MUSES02.html](https://www.njr.com/semicon/products/MUSES02.html) | product_page | medium | Older njr.com product-page path. It differs from the known /electronic_device/products/ URL. Archive snapshots may link to dated datasheet PDFs. |
| New Japan Radio (NJR) | MUSES02_E | revision not shown | unknown | [digikey.at/htmldatasheets/production/6…4/0/0/1/muses02.html](https://www.digikey.at/htmldatasheets/production/663074/0/0/1/muses02.html) | distributor_mirror | low | Regional mirror of the known digikey.com HTML datasheet (same production ID 663074), so it is probably the same revision. |
| New Japan Radio (NJR) | MUSES02_E | revision not shown | unknown | [alldatasheet.jp/datasheet-pdf/pdf/808061/NJRC/MUSES02.html](https://www.alldatasheet.jp/datasheet-pdf/pdf/808061/NJRC/MUSES02.html) | third_party_mirror | low | Japanese mirror of alldatasheet document 808061. That is the same file as the known alldatasheet.com entry (12 pages, 396 KB). |
| New Japan Radio (NJR) | MUSES02_E (listed as MUSE02) | revision not shown | unknown | [alldatasheet.jp/datasheet-pdf/pdf/1244749/NJRC/MUSE02.html](https://www.alldatasheet.jp/datasheet-pdf/pdf/1244749/NJRC/MUSE02.html) | third_party_mirror | low | Japanese mirror of alldatasheet document 1244749. That is the same file as the known alldatasheet.com MUSE02 entry. It is a later upload ID than 808061, so it may hold a different Ver. |
| New Japan Radio (NJR) | MUSES02_E | revision not shown | unknown | [alldatasheet.com/datasheet-pdf/view/808061/NJRC/MUSES02.html](https://www.alldatasheet.com/datasheet-pdf/view/808061/NJRC/MUSES02.html) | third_party_mirror | low | Page-view rendering of alldatasheet document 808061. The rendered page text may show the Ver. header. |
| New Japan Radio (NJR) | MUSES02_E | revision not shown | unknown | [datasheet.jp/pdf/1007642/MUSES02.html](http://www.datasheet.jp/pdf/1007642/MUSES02.html) | third_party_mirror | low | Uses the same ID (1007642) as the known datasheet4u copy, so it is probably the same file. |
| New Japan Radio (NJR) | MUSES02_E | revision not shown | unknown | [datasheetspdf.com/datasheet/MUSES02.html](https://datasheetspdf.com/datasheet/MUSES02.html) | third_party_mirror | low | Third-party copy; the search summary did not show its revision. |
| New Japan Radio (NJR) | MUSES02_E | revision not shown | unknown | [digchip.com/datasheets/parts/datasheet/330/MUSES02.php](https://www.digchip.com/datasheets/parts/datasheet/330/MUSES02.php) | third_party_mirror | low | Third-party copy; the search summary did not show its revision. |
| Nisshinbo Micro Devices | - | - | - | [digikey.com/en/products/detail/nisshin…-inc/MUSES02/2202386](https://www.digikey.com/en/products/detail/nisshinbo-micro-devices-inc/MUSES02/2202386) | product_page | low | DigiKey part 2202386. The page links to the current datasheet, and archive snapshots may preserve older linked revisions. |
| Nisshinbo Micro Devices | - | - | - | [mouser.com/ProductDetail/Nisshinbo/MUS…yhhPORZIYvXQtw%3D%3D](https://www.mouser.com/ProductDetail/Nisshinbo/MUSES02?qs=lTIKtKbByhhPORZIYvXQtw%3D%3D) | product_page | low | Mouser product page. The EU mirror is eu.mouser.com/ProductDetail/NJR/MUSES02 with the same qs value. The linked datasheet is probably the /ds/2/294/ copy. |
| New Japan Radio (NJR) | - | - | - | [win-source.net/products/detail/njr-cor…on-njrc/muses02.html](https://www.win-source.net/products/detail/njr-corporation-njrc/muses02.html) | product_page | low | Distributor page; may host a cached datasheet. Revision not shown. |
| New Japan Radio (NJR) | - | - | - | [integrated-circuit.com/products-detail…S02/EIS-1388003.html](https://www.integrated-circuit.com/products-detail/MUSES02/EIS-1388003.html) | product_page | low | Broker page; may host a cached datasheet. Revision not shown. |

### Revision chain status

MUSES02_E (English, NJR then Nisshinbo): Ver.2009-12-18 (launch; header confirmed on Mouser pdfdocs copy) -> Ver.2015-04-13 (header confirmed on Mouser /ds/2/294/MUSES02_E-259016.pdf) -> current Nisshinbo English reissue (date unknown). Missing: any Ver. dated 2010-2014 or 2016-2021, and the date of the Nisshinbo English reissue. Neither the search asking for 2010/2012/2018/2019/2020 Ver. dates nor the other searches found any. The legacy vendor URLs semicon.njr.co.jp/eng/PDF/MUSES02_E.pdf (early host) and njr.com/electronic_device/PDF/MUSES02_E.pdf (later host) are the best Wayback seeds for recovering intermediate Ver. dates. No search result showed which Ver. either one serves. MUSES02_J (Japanese): only the Nisshinbo 20250319 edition is known (it marks MUSES02D as a maintenance product). Missing: every JRC/New JRC-era Japanese Ver., including the 2009 launch edition. A sibling legacy path exists for MUSES01 (njr.co.jp/electronic_device/PDF/MUSES01_J.pdf), but no MUSES02_J URL on njr.co.jp appeared, so none is recorded. The new third-party copies (alldatasheet.jp 808061/1244749, datasheet.jp 1007642, datasheetspdf, digchip) show no revision in their summaries. They are probably duplicates of the already-known files with the same IDs.
...
- `https://www.njr.com/electronic_device/PDF/MUSES02_E.pdf`
